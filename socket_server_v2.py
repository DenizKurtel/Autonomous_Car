...
class Lane:
    ...
    def drive(self, frame):
        ...
        # self.stabilized_steering_angle = self.stabilize_steering_angle(self.stabilized_steering_angle, self.steering_angle, len(lane_lines))

        return self.steering_angle, self.stop_flag
    ...
    def region_of_interest(self, edges):
        ...
        #cv2.imshow('maskadaed', masked_image)
    ...
    def stabilize_steering_angle(self, stabilized_steering_angle, steering_angle, num_of_lane_line):
        ...
        if index < m:
            index = index + 1
            tot = tot + stabilized_steering_angle
        else:
            stabilized_steering_angle = tot/m
            index = 1
            tot = 0
